    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.titleSection}>
          <Text style={styles.pageTitle}>Job Category</Text>
            ...
            <View key={job.id} style={styles.categoryBlock}>
              ...
              <View style={styles.card}>
                ...
                <TouchableOpacity style={styles.applyButton} onPress={() => {
                  ...
                  if (job.category === 'Rural Side') {
                    router.push({ pathname: '/rural-apply', params: { name, email, jobTitle: job.title } });
                  } else if (teachingCategories.includes(job.category)) {
                    router.push({ pathname: '/teaching-apply', params: { name, email, jobTitle: job.title } });
                  } else {
                    router.push({ pathname: '/intern-apply', params: { name, email, jobTitle: job.title } });
                  }
                }}>
...
const styles = StyleSheet.create({
  ...
  typePill: {
    backgroundColor: '#E0F2F1', // Pale teal color from screenshot
