...
// Dummy Data for NGO Jobs
const NGO_JOBS = [
  {
    id: '1',
    category: 'Education Support',
    title: 'Education Support',
    company: 'CSR (Corporate Social Responsibility)',
...
export default function NgoJobsScreen() {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.titleSection}>
          <Text style={styles.pageTitle}>NGO</Text>
        ...
        <View style={styles.listContainer}>
          {NGO_JOBS.map((job) => (
            <View key={job.id} style={styles.categoryBlock}>
              ...
              <View style={styles.card}>
                <View style={styles.cardHeaderRow}>
                  ...
                  <View style={[
                    styles.typePill, 
                    job.type === 'Internship' ? styles.typePillInternship : styles.typePillWork
                  ]}>
                    <Text style={[
                      styles.typePillText, 
                      job.type === 'Internship' ? styles.typePillTextInternship : styles.typePillTextWork
                    ]}>{job.type}</Text>
                  </View>
                </View>
                ...
                <View style={styles.detailsRow}>
                  ...
                  <View style={styles.detailItem}>
                    ...
                    <Text style={styles.detailText}>{job.stipend}</Text>
                  </View>
                </View>

                <TouchableOpacity style={styles.applyButton} onPress={() => {
                  const teachingCategories = ['Training Teacher', 'Education Support', 'Counselling Staff', 'NGO Mentor'];
                  if (teachingCategories.includes(job.category)) {
                    router.push({ pathname: '/teaching-apply', params: { name, email, jobTitle: job.title } });
                  } else {
                    router.push({ pathname: '/ngo-apply', params: { name, email, jobTitle: job.title } });
                  }
                }}>
...
const styles = StyleSheet.create({
  ...
  typePillWork: {
    backgroundColor: '#E0EAEF', // Grey blue
  },
  typePillInternship: {
